        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="relative group">
              <button className="flex items-center gap-2 px-3 py-2 font-medium text-gray-600 hover:text-primary transition-colors">
                <span>Shop</span>
                <FaChevronDown className="text-xs group-hover:rotate-180 transition-transform duration-200" />
              </button>
              
              {/* Shopping Categories Dropdown */}
              <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-4">
                  <h3 className="text-sm font-semibold text-gray-800 mb-3">Shop by Category</h3>
                  <div className="space-y-2">
                    ...
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center">
                        <FaShoppingBag className="text-xs text-blue-600" />
                      </div>
                      <span className="text-sm text-gray-700 group-hover/item:text-blue-600 transition-colors font-medium">
                        All Products
                      </span>
                    </Link>
                    ...
                    <Link
                      to="/stores"
                      className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-50 transition-colors group/item mt-3 pt-3 border-t border-gray-100"
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-green-100 to-blue-100 rounded-lg flex items-center justify-center">
                        <FaStore className="text-xs text-green-600" />
                      </div>
                      <span className="text-sm text-gray-700 group-hover/item:text-blue-600 transition-colors font-medium">
                        Store Directory
                      </span>
            ...
            <div className="relative group">
              ...
              {/* Restaurant Categories Dropdown */}
              <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-4">
                  <h3 className="text-sm font-semibold text-gray-800 mb-3">Order Food Online</h3>
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      { name: 'Pizza', emoji: '🍕', color: 'from-red-100 to-orange-100', textColor: 'text-red-600' },
                      { name: 'Burgers', emoji: '🍔', color: 'from-yellow-100 to-orange-100', textColor: 'text-orange-600' },
                      { name: 'Asian', emoji: '🍜', color: 'from-green-100 to-emerald-100', textColor: 'text-green-600' },
                      { name: 'Healthy', emoji: '🥗', color: 'from-emerald-100 to-green-100', textColor: 'text-emerald-600' },
                      { name: 'Desserts', emoji: '🍰', color: 'from-pink-100 to-rose-100', textColor: 'text-pink-600' },
                      { name: 'Coffee', emoji: '☕', color: 'from-amber-100 to-yellow-100', textColor: 'text-amber-600' },
                      { name: 'Fast Food', emoji: '🌭', color: 'from-orange-100 to-red-100', textColor: 'text-orange-600' },
                      { name: 'Seafood', emoji: '🦐', color: 'from-blue-100 to-cyan-100', textColor: 'text-blue-600' }
                    ].map(category => (
                      <Link
                        key={category.name}
                      ...
                      >
                        ...
                        <span className={`text-xs font-medium ${category.textColor} group-hover/item:opacity-80 transition-opacity`}>
                          {category.name}
                        </span>
                      </Link>
                    ))}
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-100">
                    <Link
                      to="/restaurants"
                      className="flex items-center justify-center gap-2 p-2 text-sm text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-medium"
                    >
