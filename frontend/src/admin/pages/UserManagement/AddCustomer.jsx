...
import CustomerForm from "../../components/UserManagement/CustomerForm";
      ...
      <div className="pt-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            <div>
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Create a new customer account and add them to the system.</p>
            </div>
        </div>
