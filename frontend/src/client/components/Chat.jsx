...
const MessageDropdownItem = styled.button`
  ...
  color: ${({ theme }) => theme.textSecondary}; display: flex; align-items: center; gap: 10px;
...
const ContactItem = styled.div`
  ...
  cursor: pointer; border-bottom: 1px solid ${({ theme }) => theme.shadows.dark};
...
const Chat = () => {
  ...
  const handleSend = () => {
    ...
    if (!newMessages[selectedContact.id]) newMessages[selectedContact.id] = [];
